        ...
        <Box w="80%" m="auto">
            ...
            <Flex justifyContent="space-evenly" mt="10">
                        ...
                        actual.map((item)=>(
                            ...
                            <Image src={item.image} w="15%" />
                             ...
                             <Box pt="5">
                                ...
                                <Button onClick={()=>deleteItem(item._id)} className={styles.singleProductAddtoCart} mt="6" ml="20" color="blue.400">DELETE</Button>
                               </Box>
                        </Flex>
                        ))
                ...
                <Flex justifyContent="space-between">
                    ...
                    <Text fontWeight="700">₹{discountTotal}.00</Text>
                 </Flex>
