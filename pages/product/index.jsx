  ...
  async function deleteItem(delid){ 
   ...
   useEffect(() => {
    ...
    <Flex justifyContent="space-between">
      ...
      <Button variant='outline' colorScheme='blue' mr={100} mt={100} onClick={showCart}><BsFillCartFill />Cart Items</Button>
    </Flex>
     ...
     <Flex m="auto" width={['100%','70%']} mt="20" >
          ...
          <Box boxShadow = "rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px" textAlign="center" w="50%" ml="30px">
            ...
            <Button ml="2" colorScheme='green' h="7">{localData.ratings || 4} <AiOutlineStar /></Button>
                ...
                >
                  ...
                  <DrawerContent>
                    ...
                    <DrawerBody>
                        ...
                        actual.map((item) => (
                          ...
                          <Flex key={item.image} mb="7" justifyContent="space-evenly">
                            ...
                            <Box>
                              ...
                              <Button bgColor="red.200" ml="2" color="red" onClick={()=>deleteItem(item._id)}>Delete</Button>
                            </Box>
                          </Flex>
                      ...
                      <Text ml="2" color="teal" fontSize="2xl" fontWeight="500">₹ {total}</Text>
                      </Flex>
